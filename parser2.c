...
/*                                                                          */
/*                                                                          */
/*       Skeleton parser file for parser2.  This is essentially just a      */
...
/*       parser2.c, a program that can *parse* (not compile) all aspects    */
/*       of a CPL program fed into it and implement syntactic error         */
/*       error reporting and recovery using the Augmented S-Algol           */
/*       technique discussed in the lectures.                               */
/*                                                                          */
/*       The  implementation of parser2 is     								*/
/*       a copy your tested and working version of parser1.c and use it     */
/*       as a base to build parser2.  This is because there is a large      */
/*       common subset of code shared between the two parsers.              */
/*                                                                          */
/*                                                                          */
/*       													                */
/*                                                                          */
...
PRIVATE void ParseSubTerm( void ){
	if ( CurrentToken.code == LEFTPARENTHESIS ){
		...
		Accept( INTCONST ); // if its <IntConst> production
	}
}
